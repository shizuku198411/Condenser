...
type CertHandler interface {
	...
	IssueClientCertFromCSR(csr *x509.CertificateRequest, caCert *x509.Certificate, caKey *rsa.PrivateKey, spiffe *url.URL, id string, validFor time.Duration) ([]byte, error)
}
